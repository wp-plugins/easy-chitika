...
if (!class_exists("providerWidget")) {
  class providerWidget extends WP_Widget {
    ...
    function form($instance) {
      ...
      echo '<a href="options-general.php?page=easy-ads.php"> ';
  ...
  class Overview extends ezOverview {
    ...
    function renderContent()
    {
      ...
      $planText = '<h4>Future Plans</h4>' .
        ...
        ezTab::makeLIwithTooltip('Ad Space Sharing',
  ...
  class Admin extends ezAdmin {
    ...
    function renderContent() {
      ...
      $picText = "<span id='ad-slot' style='text-decoration:underline' onmouseover=\"Tip('" .
        htmlspecialchars("<img src=\'" . $url . "/ad-slots.gif\'") .
    ...
    function renderForm() {
      ...
      if (ezNS::$isPro) {
        echo '<b><font color="red">Pro Features: </font>' ;
        parent::renderForm() ;
      }
      else {
        $plgName = ezNS::$baseName ;
    ...
    function defineSubmitButtons() { // Add submit buttons
      ...
      $button = &$this->addSubmitButton('submit', 'clean_db') ;
      $properties = array('value' => 'Clean Database',
          'title' => 'DANGER: Delete all options from the database.');
      $button->set($properties) ;
    }
  } // End: Class Admin
}
