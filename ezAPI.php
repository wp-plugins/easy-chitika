...
if (!class_exists("easyChitikaNS")) {
  class easyChitikaNS { // Name Space simulation
    ...
    static $isFiltered, $isPure, $gCount, $mced, $b64, $isPro, $strPro ;
    static function setNS($FILE, $PLUGINDIR) {
      ...
      $isPro = file_exists($CWD.'/pro/pro.php') ;
      if ($isPro) $strPro = " Pro" ;
      else $strPro = " Lite" ;
...
if (!class_exists("ezOption")) {
  ...
  class blurb extends ezOption { // Not an option, but a fancy message in the admin panel
    ...
    function render() {
      ...
      $why = addslashes($this->why) ;
      echo "<li>" .  ezTab::makeTextWithTooltip($text, $this->title, $value, 350, false) ;
      if ($price >= 0)
        echo ezTab::makeTextWithTooltip($moreInfo, $why, "Why go Pro?", 300, false) ;
      echo "</li>\n" ;
      if (!empty($this->after)) echo $this->after, "\n" ;
    }
  } // End: Class blurb
...
if (!class_exists("ezTab")) {
  class ezTab {
    ...
    function ezTab($name, $defaults) {
      $this->name = $name ;
      $themeName = ezNS::$themeName ;
      $CWD = ezNS::$CWD ;
      $baseName = ezNS::$baseName ;
      $pluginName = ezNS::$pluginName ;
    ...
    function get($optionName) {// Return an option value
      ...
      // The requested option is not found
      // echo ("Fatal Error: <code>get('$optionName')</code> in " .
      //     $this->name . " Option doesn't exist!") ;
    }
    function set($optionName, $value) {// Set an option value
      echo ("Who dares to call <code>set('$optionName') = $value</code> in " .
        $this->name . "?! It is defunct.") ;
      if (!empty($this->options[$optionName]))
...
if (!class_exists("ezOverview")) {
  class ezOverview extends ezTab {
    ...
    function renderContent() {
      $supportText = "<div style=\"width:280px;background-color:#cff;padding:5px;border: solid 1px\" id=\"support\"><b>Support this Plugin!</b><br /><span style='text-decoration:underline' onmouseover=\"TagToTip('share', WIDTH, 230, TITLE, 'Ad Space Sharing',STICKY, 1, CLOSEBTN, true, CLICKCLOSE, true, FIX, [this, 5, 2])\" onmouseout=\"UnTip()\">Share a small fraction of your ad space</span>,<br />Buy <span style=\"text-decoration:underline\" onmouseover=\"TagToTip('unreal', WIDTH, 205, TITLE, 'Buy &lt;em&gt;The Unreal Universe&lt;/em&gt;',STICKY, 1, CLOSEBTN, true, CLICKCLOSE, true, FIX, [this, 5, 2])\"><b style=\"color:#a48;font-variant: small-caps;text-decoration:underline\">The Unreal Universe</b></span> or <span style=\"text-decoration:underline\" onmouseover=\"TagToTip('pqd', WIDTH, 205, TITLE, '&lt;em&gt;Principles of Quant. Devel.&lt;/em&gt;',STICKY, 1, CLOSEBTN, true, CLICKCLOSE, true, FIX, [this, 5, 2])\"><b style=\"color:#84a;font-variant: small-caps;text-decoration:underline\">Principles of Quantitative Development</b></span>.</div><br />" ;
      echo $supportText ;
    }
  } // End: Class Overview
}
  ...
  class ezAbout extends ezTab {
    ...
    function renderContent() {
      echo '<table class="form-table" >', "\n",  '<tr><th scope="row"><b>' ,
        ezNS::$name, "</b></th></tr>\n<tr><td>\n",
        '<ul style="padding-left:10px;list-style-type:circle; list-style-position:inside;" >', "\n" ;
      if (!empty($this->blurbs[ezNS::$baseName])) $this->blurbs[ezNS::$baseName]->render() ;

      echo "<li>Please report any problems. And share your thoughts and comments.&nbsp;",
        '<a href="http://wordpress.org/tags/' . ezNS::$baseName .
        '" title="Post it in the WordPress forum" target="_blank">[WordPress Forum]</a>',
        'Or <a href="#" title="Contact the plugin author through email" ',
        'onclick="TagToTip(\'help7\', WIDTH, 1000, TITLE, \'Contact Manoj\',',
        'STICKY, 1, CLOSEBTN, true, FIX, [20,20])">[Email Author]</a>',
        '<span id="help7"><iframe src="http://manoj.thulasidas.com/mail.shtml" ',
        'width="1024px" height="1024px"></iframe></span></li>' ;

      echo "</ul>\n</td>\n</tr>\n<tr><th scope='row'><b>Other Plugins</b></th></tr>\n<tr><td>" ,
        '<ul style="padding-left:10px;list-style-type:circle; list-style-position:inside;" >' ;

      if (!empty($this->blurbs)) {
        foreach ($this->blurbs as $k => $b) {
          if ($k != ezNS::$name && !empty($b)) $b->render() ;
        }
      }
      echo "</ul>\n</td>\n</tr>\n</table>\n" ;
...
if (!class_exists("ezPlugin")) {
  class ezPlugin {
    ...
    function renderAdminPage() {
      ...
      echo "<h2>", $this->name.ezNS::$strPro, " Setup</h2><br />" ;
      ...
      if ($haveExtras) $this->submitMessage .= ezExtras::handlePolicySubmit() ;
      echo $this->submitMessage ;
      echo $this->errorMessage ;
      // if ($haveExtras) ezExtras::showPolicyConfirmation() ;
      ...
      // @include ($this->CWD . '/ezSupport.php');
      echo "\n</div><!-- of wrap -->\n" ;
    }
